...
from app.routes.auth_route_v1 import create_access_token, verify_access_token
...
def test_login_success(mocker):
    ...
    """
    mocker.patch("app.routes.auth_route_v1.user_exists", return_value=True)
    mocker.patch("app.routes.auth_route_v1.get_user_by_username", return_value={
...
def test_login_failure_invalid_credentials(mocker):
    ...
    """
    mocker.patch("app.routes.auth_route_v1.user_exists", return_value=False)
...
async def test_verify_access_token_valid(mocker):
    ...
    """
    mocker.patch("app.routes.auth_route_v1.jwt.decode",
