...
GoodBot API is a FastAPI backend application for the GoodBot Project. It provides REST APIs for managing litigations, experts, nonprofits/entities, and full-text search functionality. The application uses Supabase as the database backend and integrates Google Gemini 2.0 Flash (via LangChain) for AI-powered content generation.
